...
namespace KoreEngine.Hardware.Hexapod
{
    ...
    public class GCS2
    {
        ...
        */
        ...
        [DllImport(PI_GCS2_DLL_NAME, EntryPoint = "PI_GetInitError")]               public static extern int    GetInitError();
        ...
        [DllImport(PI_GCS2_DLL_NAME, EntryPoint = "PI_qFRF")]          public static extern int qFRF(int ID, string sAxes, int[] bValueArray);
